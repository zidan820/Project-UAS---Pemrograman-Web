...
if (isset($_POST['update'])) {
    ...
    $kontak = $_POST['kontak'];
    $alamat = $_POST['alamat'];
    mysqli_query($koneksi, "UPDATE pelanggan SET nama_pelanggan='$nama', kontak='$kontak', alamat='$alamat' WHERE id='$id'");
...
<div class="d-flex">
    <div class="bg-dark text-white p-3" style="width:250px; min-height:100vh;">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item"><a href="index.php" class="nav-link text-white">👥 Pelanggan</a></li>
