...
if (isset($_POST['simpan'])) {
    ...
    mysqli_query($koneksi, "INSERT INTO retur (tanggal_retur, id_barang, jumlah, keterangan) VALUES ('$tanggal', '$id_barang', '$jumlah', '$keterangan')");

    // Update stok (Tambah kembali ke stok)
